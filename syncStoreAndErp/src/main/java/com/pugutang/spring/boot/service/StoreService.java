package com.pugutang.spring.boot.service;
...
import com.pugutang.spring.boot.dao.newDao.PgtInboundNoticeDetailsMapper;
import com.pugutang.spring.boot.dao.newDao.PgtInboundNoticeMapper;
import com.pugutang.spring.boot.dao.newDao.PgtInboundNoticeStockBatchMapper;
import com.pugutang.spring.boot.dao.newDao.PgtOrderGoodsMapper;
import com.pugutang.spring.boot.dao.newDao.PgtOrderMapper;
import com.pugutang.spring.boot.dao.newDao.PgtOrderStockBatchMapper;
import com.pugutang.spring.boot.dao.newDao.PgtOutboundDetailMapper;
import com.pugutang.spring.boot.dao.newDao.PgtOutboundMapper;
import com.pugutang.spring.boot.dao.newDao.PgtOutboundNoticeDetailMapper;
import com.pugutang.spring.boot.dao.newDao.PgtOutboundNoticeMapper;
import com.pugutang.spring.boot.dao.newDao.PgtStoreShopMapper;
import com.pugutang.spring.boot.dao.newDao.SerialConfigMapper;
import com.pugutang.spring.boot.dao.newDao.SzyGoodsSku6Mapper;
import com.pugutang.spring.boot.dao.newDao.SzyStockGoods6Mapper;
import com.pugutang.spring.boot.dao.newDao.SzyStoreMapper;
import com.pugutang.spring.boot.domain.Result;
...
import com.pugutang.spring.boot.entity.SzyOrder;
import com.pugutang.spring.boot.entity.SzyOrderGoods;
